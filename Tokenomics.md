...
### 1.3 $SAIL Token - Rental and Redistribution
...
The parent DAO acts as the overarching entity that manages the yacht sharing ecosystem. It oversees multiple yacht UPs, each representing a specific yacht. The parent DAO is responsible for financing the purchase of these assets, through the underwriting from a bank. It should assist in helping acquire new yachts and expand the platform's fleet. It also facilitates the onboarding of service providers, such as insurance companies and maintenance crews, to ensure the yachts are well-maintained and protected.

The parent DAO utilizes the LSP9 (Vault) standard to securely hold and manage funds for the ecosystem. Why would someone want our governance token? With these funds we can as a collective get better deals for covering the fleet with insurance, crew, and facilitation. The use of a vault ensures transparency, security, and efficient management of the platform's financial resources.

### 2.1 Governance Token
The governance token is used for decision-making and governance within the parent DAO. Token holders can participate in platform-wide decisions, such as the acquisition of new types of yachts, changes to the tokenomics, and the onboarding of service providers. The governance token ensures that the platform remains decentralized and community-driven, with stakeholders having a say in its direction and growth. Stakeholders that are directly contributing to our goals of more sailors and more sailing.

The governance token can be distributed to yacht DAO owners, strong community members, and other stakeholders who contribute to the platform's success.
